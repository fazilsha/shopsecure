...
# Root resource already exists, create path resources
...
# Products method and integration
...
resource "aws_api_gateway_method" "auth_validate_method" {
  rest_api_id   = aws_api_gateway_rest_api.main_api.id
...
resource "aws_api_gateway_integration" "auth_validate_integration" {
  rest_api_id             = aws_api_gateway_rest_api.main_api.id
  resource_id             = aws_api_gateway_resource.auth_validate.id
  http_method             = aws_api_gateway_method.auth_validate_method.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = aws_lambda_function.auth_lambda.invoke_arn
}
